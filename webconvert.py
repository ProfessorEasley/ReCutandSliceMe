...
if __name__ == '__main__':
    ...
    info_path = os.path.join(args.assets_folder, 'exported_assets_info.json')
    if not os.path.exists(info_path):
        print('Error: Did not find exported_assets_info.json in the specified directory')
        exit(1)
    ...
    wp_path = os.path.join(args.assets_folder, 'mockup.html')
